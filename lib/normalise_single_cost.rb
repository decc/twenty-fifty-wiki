...
class NormaliseSingleCost
  ...
  CURRENCY_YEAR = {"1990" => 1.72663858,"1991" => 1.621875862,"1992" => 1.56311059,"1993" => 1.519410469,"1994" => 1.495752064,"1995" => 1.456727898,"1996" => 1.405856799,"1997" => 1.367727111,"1998" => 1.338061149,"1999" => 1.310547285,"2000" => 1.29520257,"2001" => 1.268246902,"2002" => 1.230148479,"2003" => 1.193474084,"2004" => 1.164144354,"2005" => 1.140966399,"2006" => 1.107174491,"2007" => 1.075002956,"2008" => 1.044026602,"2009" => 1.029155989,"2010" => 1.0, "2011" => 1.0, "2012" => 1.016756141}
  PREFIX = {'trn' => 1e12, 'tr' => 1e12, 'bn' => 1e9, 'p' => 1e15, 't' => 1e12,  'g' => 1e9, 'm' => 1e6, 'k' => 1e3}
  POWER_UNIT = { 'therm' => (41.868e9/396.83),'toe' => 41.868e9, 'boe' => 5.86152e9, 'wh' => (1*60*60), 'w' => (1*60*60*24*365.25), 'j' => 1.0, 'tcoal' => (26.1e9), 'bbl' => 5.86152e9, 'btu' => 1055 }
  OTHER_UNITS = {'unit' => 1.0, 'household' => 1.0, 'car' => 1.0, 'train' => 1.0, 'aeroplane' => 1.0, 'house' => 1.0, 'tco2' => 1, 'tco2e' => 1,'tonne' => 1.0}
  POWER_SUFFIX = {'peak' => :peak, 'average' => :average, 'p' => :peak, 'av' => :average, 'a' => :average}
  PERIOD_SUFFIX = {'/year' => 1.0, '/yr' => 1.0,'/y' => 1.0}
  
  P = " *(#{PREFIX.keys.join("|").gsub('|t|','|t(?!oe|herm|rain|co2|co2e|onne)|')})?"
