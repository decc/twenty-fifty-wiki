...
describe "cost_categories/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit cost_category form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => cost_categories_path(@cost_category), :method => "post" do
